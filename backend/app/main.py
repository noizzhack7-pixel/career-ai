...
from app.api.v1.routers import skills, positions, smart, assessment, employees
...
app.add_middleware(
    CORSMiddleware,
    allow_origins=["http://localhost:4200", "http://127.0.0.1:4200", "http://localhost:5173", "http://localhost:3000"],
