    ...
    >
      ...
      <div className="pt-16 pb-6 px-6">
        <div className="flex justify-between items-start mb-6">
           <div>
              <h1 className="text-2xl font-bold text-primary mb-0.5 group-hover:text-primary-dark transition-colors">תמר כהן</h1>
              <p className="text-base font-bold text-neutral-dark mb-3">מפתחת תוכנה בכירה</p>
